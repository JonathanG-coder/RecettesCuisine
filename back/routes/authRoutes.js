...
import { register, loginUser, deleteUser, logoutUser, getMe } from "../controllers/authController.js";
...
router.post("/", verifyToken, requireAuth(["admin"]), validate(registerSchema), register);
